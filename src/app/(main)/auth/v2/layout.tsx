      ...
      <div className="grid h-dvh justify-center p-2 lg:grid-cols-2">
        <div className="bg-primary relative order-2 hidden h-full rounded-3xl lg:flex">
          <div className="text-primary-foreground absolute top-10 space-y-1 px-10">
            ...
            <p className="text-sm">Intégrité. Transparence. Justice.</p>
          </div>

          <div className="absolute bottom-10 flex w-full justify-between px-10">
            <div className="text-primary-foreground flex-1 space-y-1">
              <h2 className="font-medium">Version Démo</h2>
              <p className="text-sm">Cette plateforme présente les fonctionnalités principales du système de gestion AILC.</p>
            </div>
            <Separator orientation="vertical" className="mx-3 !h-auto" />
            <div className="text-primary-foreground flex-1 space-y-1">
              <h2 className="font-medium">Besoin d&apos;aide?</h2>
              <p className="text-sm">
                Consultez le fichier AILC_README.md pour les instructions d&apos;utilisation complètes.
              </p>
            </div>
          </div>
        </div>
